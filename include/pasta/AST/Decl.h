...
class Decl {
 ...
 protected:
  ...
  union {
    ...
    const ::clang::ClassScopeFunctionSpecializationDecl
    ...
    const ::clang::VarTemplatePartialSpecializationDecl
  ...
  inline explicit Decl(std::shared_ptr<ASTImpl> ast_,
                       const ::clang::Decl *decl_, DeclKind kind_)
      : ast(std::move(ast_)),
        kind(kind_) {
    u.Decl = decl_;
  }
 ...
 protected:
  explicit Decl(std::shared_ptr<ASTImpl> ast_, const ::clang::Decl *decl_);
};
...
class EmptyDecl : public Decl {
 ...
 protected:
  explicit EmptyDecl(std::shared_ptr<ASTImpl> ast_,
...
class ExportDecl : public Decl {
 ...
 protected:
  explicit ExportDecl(std::shared_ptr<ASTImpl> ast_,
...
class ExternCContextDecl : public Decl {
 ...
 protected:
  explicit ExternCContextDecl(std::shared_ptr<ASTImpl> ast_,
...
class FileScopeAsmDecl : public Decl {
 ...
 protected:
  explicit FileScopeAsmDecl(std::shared_ptr<ASTImpl> ast_,
...
class FriendDecl : public Decl {
 ...
 protected:
  explicit FriendDecl(std::shared_ptr<ASTImpl> ast_,
...
class FriendTemplateDecl : public Decl {
 ...
 protected:
  explicit FriendTemplateDecl(std::shared_ptr<ASTImpl> ast_,
...
class ImportDecl : public Decl {
 ...
 protected:
  explicit ImportDecl(std::shared_ptr<ASTImpl> ast_,
...
class LifetimeExtendedTemporaryDecl : public Decl {
 public:
  ...
  LifetimeExtendedTemporaryDecl(const LifetimeExtendedTemporaryDecl &) =
      default;
  LifetimeExtendedTemporaryDecl(LifetimeExtendedTemporaryDecl &&) noexcept =
      default;
  LifetimeExtendedTemporaryDecl &
  operator=(const LifetimeExtendedTemporaryDecl &) = default;
  LifetimeExtendedTemporaryDecl &
  operator=(LifetimeExtendedTemporaryDecl &&) noexcept = default;
...
class LinkageSpecDecl : public Decl {
 ...
 protected:
  explicit LinkageSpecDecl(std::shared_ptr<ASTImpl> ast_,
...
class NamedDecl : public Decl {
 ...
 protected:
  explicit NamedDecl(std::shared_ptr<ASTImpl> ast_,
...
class NamespaceAliasDecl : public NamedDecl {
 ...
 protected:
  explicit NamespaceAliasDecl(std::shared_ptr<ASTImpl> ast_,
...
class NamespaceDecl : public NamedDecl {
 ...
 protected:
  explicit NamespaceDecl(std::shared_ptr<ASTImpl> ast_,
...
class OMPAllocateDecl {
 ...
 protected:
  explicit OMPAllocateDecl(std::shared_ptr<ASTImpl> ast_,
...
class OMPDeclareMapperDecl {
 ...
 protected:
  explicit OMPDeclareMapperDecl(std::shared_ptr<ASTImpl> ast_,
...
class OMPRequiresDecl {
 ...
 protected:
  explicit OMPRequiresDecl(std::shared_ptr<ASTImpl> ast_,
...
class OMPThreadPrivateDecl {
 ...
 protected:
  explicit OMPThreadPrivateDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCCompatibleAliasDecl : public NamedDecl {
 public:
  ...
  operator=(ObjCCompatibleAliasDecl &&) noexcept = default;
...
class ObjCContainerDecl : public NamedDecl {
 ...
 protected:
  explicit ObjCContainerDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCImplDecl : public ObjCContainerDecl {
 ...
 protected:
  explicit ObjCImplDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCImplementationDecl : public ObjCImplDecl {
 public:
  ...
  operator=(ObjCImplementationDecl &&) noexcept = default;
 ...
 protected:
  explicit ObjCImplementationDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCInterfaceDecl : public ObjCContainerDecl {
 ...
 protected:
  explicit ObjCInterfaceDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCMethodDecl : public NamedDecl {
 ...
 protected:
  explicit ObjCMethodDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCPropertyDecl : public NamedDecl {
 ...
 protected:
  explicit ObjCPropertyDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCPropertyImplDecl : public Decl {
 ...
 protected:
  explicit ObjCPropertyImplDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCProtocolDecl : public ObjCContainerDecl {
 ...
 protected:
  explicit ObjCProtocolDecl(std::shared_ptr<ASTImpl> ast_,
...
class PragmaCommentDecl : public Decl {
 ...
 protected:
  explicit PragmaCommentDecl(std::shared_ptr<ASTImpl> ast_,
...
class PragmaDetectMismatchDecl : public Decl {
 public:
  ...
  operator=(const PragmaDetectMismatchDecl &) = default;
  PragmaDetectMismatchDecl &
  operator=(PragmaDetectMismatchDecl &&) noexcept = default;
...
class RequiresExprBodyDecl : public Decl {
 ...
 protected:
  explicit RequiresExprBodyDecl(std::shared_ptr<ASTImpl> ast_,
...
class StaticAssertDecl : public Decl {
 ...
 protected:
  explicit StaticAssertDecl(std::shared_ptr<ASTImpl> ast_,
...
class TemplateDecl : public NamedDecl {
 ...
 protected:
  explicit TemplateDecl(std::shared_ptr<ASTImpl> ast_,
...
class TemplateTemplateParmDecl : public TemplateDecl {
 public:
  ...
  operator=(const TemplateTemplateParmDecl &) = default;
  TemplateTemplateParmDecl &
  operator=(TemplateTemplateParmDecl &&) noexcept = default;
...
class TranslationUnitDecl : public Decl {
 ...
 protected:
  explicit TranslationUnitDecl(std::shared_ptr<ASTImpl> ast_,
...
class TypeDecl : public NamedDecl {
 ...
 protected:
  explicit TypeDecl(std::shared_ptr<ASTImpl> ast_,
...
class TypedefNameDecl : public TypeDecl {
 ...
 protected:
  explicit TypedefNameDecl(std::shared_ptr<ASTImpl> ast_,
...
class UnresolvedUsingTypenameDecl : public TypeDecl {
 public:
  ...
  UnresolvedUsingTypenameDecl(UnresolvedUsingTypenameDecl &&) noexcept =
      default;
  UnresolvedUsingTypenameDecl &
  operator=(const UnresolvedUsingTypenameDecl &) = default;
  UnresolvedUsingTypenameDecl &
  operator=(UnresolvedUsingTypenameDecl &&) noexcept = default;
...
class UsingDecl : public NamedDecl {
 ...
 protected:
  explicit UsingDecl(std::shared_ptr<ASTImpl> ast_,
...
class UsingDirectiveDecl : public NamedDecl {
 ...
 protected:
  explicit UsingDirectiveDecl(std::shared_ptr<ASTImpl> ast_,
...
class UsingPackDecl : public NamedDecl {
 ...
 protected:
  explicit UsingPackDecl(std::shared_ptr<ASTImpl> ast_,
...
class UsingShadowDecl : public NamedDecl {
 ...
 protected:
  explicit UsingShadowDecl(std::shared_ptr<ASTImpl> ast_,
...
class ValueDecl : public NamedDecl {
 ...
 protected:
  explicit ValueDecl(std::shared_ptr<ASTImpl> ast_,
...
class AccessSpecDecl : public Decl {
 ...
 protected:
  explicit AccessSpecDecl(std::shared_ptr<ASTImpl> ast_,
...
class BindingDecl : public ValueDecl {
 ...
 protected:
  explicit BindingDecl(std::shared_ptr<ASTImpl> ast_,
...
class BlockDecl : public Decl {
 ...
 protected:
  explicit BlockDecl(std::shared_ptr<ASTImpl> ast_,
...
class BuiltinTemplateDecl : public TemplateDecl {
 ...
 protected:
  explicit BuiltinTemplateDecl(std::shared_ptr<ASTImpl> ast_,
...
class CapturedDecl : public Decl {
 ...
 protected:
  explicit CapturedDecl(std::shared_ptr<ASTImpl> ast_,
...
class ClassScopeFunctionSpecializationDecl : public Decl {
 public:
  ...
  ClassScopeFunctionSpecializationDecl(
      const ClassScopeFunctionSpecializationDecl &) = default;
  ClassScopeFunctionSpecializationDecl(
      ClassScopeFunctionSpecializationDecl &&) noexcept = default;
  ClassScopeFunctionSpecializationDecl &
  operator=(const ClassScopeFunctionSpecializationDecl &) = default;
  ClassScopeFunctionSpecializationDecl &
  operator=(ClassScopeFunctionSpecializationDecl &&) noexcept = default;
...
class ConceptDecl : public TemplateDecl {
 ...
 protected:
  explicit ConceptDecl(std::shared_ptr<ASTImpl> ast_,
...
class ConstructorUsingShadowDecl : public UsingShadowDecl {
 public:
  ...
  operator=(const ConstructorUsingShadowDecl &) = default;
  ConstructorUsingShadowDecl &
  operator=(ConstructorUsingShadowDecl &&) noexcept = default;

  bool ConstructsVirtualBase(void) const;
  ::pasta::CXXRecordDecl ConstructedBaseClass(void) const;
  ::pasta::ConstructorUsingShadowDecl
  ConstructedBaseClassShadowDecl(void) const;
...
class DeclaratorDecl : public ValueDecl {
 ...
 protected:
  explicit DeclaratorDecl(std::shared_ptr<ASTImpl> ast_,
...
class EnumConstantDecl : public ValueDecl {
 ...
 protected:
  explicit EnumConstantDecl(std::shared_ptr<ASTImpl> ast_,
...
class FieldDecl : public DeclaratorDecl {
 ...
 protected:
  explicit FieldDecl(std::shared_ptr<ASTImpl> ast_,
...
class FunctionDecl : public DeclaratorDecl {
 ...
 protected:
  explicit FunctionDecl(std::shared_ptr<ASTImpl> ast_,
...
class IndirectFieldDecl : public ValueDecl {
 ...
 protected:
  explicit IndirectFieldDecl(std::shared_ptr<ASTImpl> ast_,
...
class LabelDecl : public NamedDecl {
 ...
 protected:
  explicit LabelDecl(std::shared_ptr<ASTImpl> ast_,
...
class MSGuidDecl : public ValueDecl {
 ...
 protected:
  explicit MSGuidDecl(std::shared_ptr<ASTImpl> ast_,
...
class MSPropertyDecl : public DeclaratorDecl {
 ...
 protected:
  explicit MSPropertyDecl(std::shared_ptr<ASTImpl> ast_,
...
class NonTypeTemplateParmDecl : public DeclaratorDecl {
 public:
  ...
  operator=(NonTypeTemplateParmDecl &&) noexcept = default;
...
class OMPDeclareReductionDecl : public ValueDecl {
 public:
  ...
  operator=(OMPDeclareReductionDecl &&) noexcept = default;
...
class ObjCAtDefsFieldDecl : public FieldDecl {
 ...
 protected:
  explicit ObjCAtDefsFieldDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCCategoryDecl : public ObjCContainerDecl {
 ...
 protected:
  explicit ObjCCategoryDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCCategoryImplDecl : public ObjCImplDecl {
 ...
 protected:
  explicit ObjCCategoryImplDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCIvarDecl : public FieldDecl {
 ...
 protected:
  explicit ObjCIvarDecl(std::shared_ptr<ASTImpl> ast_,
...
class ObjCTypeParamDecl : public TypedefNameDecl {
 ...
 protected:
  explicit ObjCTypeParamDecl(std::shared_ptr<ASTImpl> ast_,
...
class RedeclarableTemplateDecl : public TemplateDecl {
 public:
  ...
  operator=(const RedeclarableTemplateDecl &) = default;
  RedeclarableTemplateDecl &
  operator=(RedeclarableTemplateDecl &&) noexcept = default;
...
class TagDecl : public TypeDecl {
 ...
 protected:
  explicit TagDecl(std::shared_ptr<ASTImpl> ast_,
...
class TemplateParamObjectDecl : public ValueDecl {
 public:
  ...
  operator=(TemplateParamObjectDecl &&) noexcept = default;
...
class TemplateTypeParmDecl : public TypeDecl {
 ...
 protected:
  explicit TemplateTypeParmDecl(std::shared_ptr<ASTImpl> ast_,
...
class TypeAliasDecl : public TypedefNameDecl {
 ...
 protected:
  explicit TypeAliasDecl(std::shared_ptr<ASTImpl> ast_,
...
class TypeAliasTemplateDecl : public RedeclarableTemplateDecl {
 ...
 protected:
  explicit TypeAliasTemplateDecl(std::shared_ptr<ASTImpl> ast_,
...
class TypedefDecl : public TypedefNameDecl {
 ...
 protected:
  explicit TypedefDecl(std::shared_ptr<ASTImpl> ast_,
...
class UnresolvedUsingValueDecl : public ValueDecl {
 public:
  ...
  operator=(const UnresolvedUsingValueDecl &) = default;
  UnresolvedUsingValueDecl &
  operator=(UnresolvedUsingValueDecl &&) noexcept = default;
...
class VarDecl : public DeclaratorDecl {
 ...
 protected:
  explicit VarDecl(std::shared_ptr<ASTImpl> ast_,
...
class VarTemplateDecl : public RedeclarableTemplateDecl {
 ...
 protected:
  explicit VarTemplateDecl(std::shared_ptr<ASTImpl> ast_,
...
class VarTemplateSpecializationDecl : public VarDecl {
 public:
  ...
  VarTemplateSpecializationDecl(const VarTemplateSpecializationDecl &) =
      default;
  VarTemplateSpecializationDecl(VarTemplateSpecializationDecl &&) noexcept =
      default;
  VarTemplateSpecializationDecl &
  operator=(const VarTemplateSpecializationDecl &) = default;
  VarTemplateSpecializationDecl &
  operator=(VarTemplateSpecializationDecl &&) noexcept = default;
...
class CXXDeductionGuideDecl : public FunctionDecl {
 ...
 protected:
  explicit CXXDeductionGuideDecl(std::shared_ptr<ASTImpl> ast_,
...
class CXXMethodDecl : public FunctionDecl {
 ...
 protected:
  explicit CXXMethodDecl(std::shared_ptr<ASTImpl> ast_,
...
class ClassTemplateDecl : public RedeclarableTemplateDecl {
 ...
 protected:
  explicit ClassTemplateDecl(std::shared_ptr<ASTImpl> ast_,
...
class DecompositionDecl : public VarDecl {
 ...
 protected:
  explicit DecompositionDecl(std::shared_ptr<ASTImpl> ast_,
...
class EnumDecl : public TagDecl {
 ...
 protected:
  explicit EnumDecl(std::shared_ptr<ASTImpl> ast_,
...
class FunctionTemplateDecl : public RedeclarableTemplateDecl {
 ...
 protected:
  explicit FunctionTemplateDecl(std::shared_ptr<ASTImpl> ast_,
...
class ImplicitParamDecl : public VarDecl {
 ...
 protected:
  explicit ImplicitParamDecl(std::shared_ptr<ASTImpl> ast_,
...
class OMPCapturedExprDecl : public VarDecl {
 ...
 protected:
  explicit OMPCapturedExprDecl(std::shared_ptr<ASTImpl> ast_,
...
class ParmVarDecl : public VarDecl {
 ...
 protected:
  explicit ParmVarDecl(std::shared_ptr<ASTImpl> ast_,
...
class RecordDecl : public TagDecl {
 ...
 protected:
  explicit RecordDecl(std::shared_ptr<ASTImpl> ast_,
...
class VarTemplatePartialSpecializationDecl
 ...
 public:
  ...
  VarTemplatePartialSpecializationDecl(
      const VarTemplatePartialSpecializationDecl &) = default;
  VarTemplatePartialSpecializationDecl(
      VarTemplatePartialSpecializationDecl &&) noexcept = default;
  VarTemplatePartialSpecializationDecl &
  operator=(const VarTemplatePartialSpecializationDecl &) = default;
  VarTemplatePartialSpecializationDecl &
  operator=(VarTemplatePartialSpecializationDecl &&) noexcept = default;

  // Profile: (void)
  // AssociatedConstraints: (void)
  ::pasta::VarTemplatePartialSpecializationDecl
  InstantiatedFromMember(void) const;
...
class CXXConstructorDecl : public CXXMethodDecl {
 ...
 protected:
  explicit CXXConstructorDecl(std::shared_ptr<ASTImpl> ast_,
...
class CXXConversionDecl : public CXXMethodDecl {
 ...
 protected:
  explicit CXXConversionDecl(std::shared_ptr<ASTImpl> ast_,
...
class CXXDestructorDecl : public CXXMethodDecl {
 ...
 protected:
  explicit CXXDestructorDecl(std::shared_ptr<ASTImpl> ast_,
...
class CXXRecordDecl : public RecordDecl {
 ...
 protected:
  explicit CXXRecordDecl(std::shared_ptr<ASTImpl> ast_,
...
class ClassTemplateSpecializationDecl : public CXXRecordDecl {
 public:
  ...
  ClassTemplateSpecializationDecl(const ClassTemplateSpecializationDecl &) =
      default;
  ClassTemplateSpecializationDecl(ClassTemplateSpecializationDecl &&) noexcept =
      default;
  ClassTemplateSpecializationDecl &
  operator=(const ClassTemplateSpecializationDecl &) = default;
  ClassTemplateSpecializationDecl &
  operator=(ClassTemplateSpecializationDecl &&) noexcept = default;
...
class ClassTemplatePartialSpecializationDecl
 ...
 public:
  ...
  ClassTemplatePartialSpecializationDecl(
      const ClassTemplatePartialSpecializationDecl &) = default;
  ClassTemplatePartialSpecializationDecl(
      ClassTemplatePartialSpecializationDecl &&) noexcept = default;
  ClassTemplatePartialSpecializationDecl &
  operator=(const ClassTemplatePartialSpecializationDecl &) = default;
  ClassTemplatePartialSpecializationDecl &
  operator=(ClassTemplatePartialSpecializationDecl &&) noexcept = default;
  ...
  InstantiatedFromMember(void) const;
  ::pasta::ClassTemplatePartialSpecializationDecl
  InstantiatedFromMemberTemplate(void) const;
