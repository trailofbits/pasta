...
void RegisterToken(nb::module_ &m) {
  ...
  nb::enum_<TokenRole>(m, "TokenRole")
    ...
    .value("BEGIN_OF_MACRO_EXPANSION_MARKER", TokenRole::kBeginOfMacroExpansionMarker)
    ...
    .value("END_OF_MACRO_EXPANSION_MARKER", TokenRole::kEndOfMacroExpansionMarker)
    .value("END_OF_INTERNAL_MACRO_EVENT_MARKER", TokenRole::kEndOfInternalMacroEventMarker);
