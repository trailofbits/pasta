...
void RegisterSwiftImportAsNonGenericAttr(nb::module_ &m);
  RegisterSwiftImportAsNonGenericAttr(m);
void RegisterSwiftImportPropertyAsAccessorsAttr(nb::module_ &m);
  RegisterSwiftImportPropertyAsAccessorsAttr(m);
...
void RegisterSwiftVersionedAdditionAttr(nb::module_ &m);
  RegisterSwiftVersionedAdditionAttr(m);
void RegisterSwiftVersionedRemovalAttr(nb::module_ &m);
  RegisterSwiftVersionedRemovalAttr(m);
...
void RegisterArmInOutAttr(nb::module_ &m);
  RegisterArmInOutAttr(m);
void RegisterArmLocallyStreamingAttr(nb::module_ &m);
  RegisterArmLocallyStreamingAttr(m);
...
void RegisterBPFPreserveStaticOffsetAttr(nb::module_ &m);
  RegisterBPFPreserveStaticOffsetAttr(m);
...
void RegisterCodeAlignAttr(nb::module_ &m);
  RegisterCodeAlignAttr(m);
void RegisterCodeModelAttr(nb::module_ &m);
  RegisterCodeModelAttr(m);
...
void RegisterHLSLParamModifierAttr(nb::module_ &m);
  RegisterHLSLParamModifierAttr(m);
