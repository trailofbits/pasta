...
enum class TokenKind : unsigned short {
  ...
  kKeyword__Is_InterfaceClass = 207,
  kKeyword__Is_Sealed = 208,
  kKeyword__Is_Destructible = 209,
  kKeyword__Is_TriviallyDestructible = 210,
  kKeyword__Is_NothrowDestructible = 211,
  kKeyword__Is_NothrowAssignable = 212,
  kKeyword__Is_Constructible = 213,
  kKeyword__Is_NothrowConstructible = 214,
  kKeyword__Is_Assignable = 215,
  kKeyword__Has_NothrowMoveAssign = 216,
  kKeyword__Has_TrivialMoveAssign = 217,
  kKeyword__Has_TrivialMoveConstructor = 218,
  kKeyword__Has_NothrowAssign = 219,
  kKeyword__Has_NothrowCopy = 220,
  kKeyword__Has_NothrowConstructor = 221,
  kKeyword__Has_TrivialAssign = 222,
  kKeyword__Has_TrivialCopy = 223,
  kKeyword__Has_TrivialConstructor = 224,
  kKeyword__Has_TrivialDestructor = 225,
  kKeyword__Has_VirtualDestructor = 226,
  kKeyword__Is_Abstract = 227,
  kKeyword__Is_Aggregate = 228,
  kKeyword__Is_BaseOf = 229,
  kKeyword__Is_Class = 230,
  kKeyword__Is_ConvertibleTo = 231,
  kKeyword = 232,
  kKeyword__Is_Enum = 233,
  kKeyword__Is_Final = 234,
  kKeyword__Is_Literal = 235,
  kKeyword__Is_Pod = 236,
  kKeyword__Is_Polymorphic = 237,
  kKeyword__Is_StandardLayout = 238,
  kKeyword__Is_Trivial = 239,
  kKeyword__Is_TriviallyAssignable = 240,
  kKeyword__Is_TriviallyConstructible = 241,
  kKeyword__Is_TriviallyCopyable = 242,
  kKeyword__Is_Union = 243,
  kKeyword__Has_UniqueObjectRepresentations = 244,
  kKeyword__UnderlyingType = 245,
  kKeyword__ReferenceBindsToTemporary = 246,
  kKeyword__Is_LvalueExpression = 247,
  kKeyword__Is_RvalueExpression = 248,
  kKeyword__Is_Arithmetic = 249,
  kKeyword__Is_FloatingPoint = 250,
  kKeyword__Is_Integral = 251,
  kKeyword__Is_CompleteType = 252,
  kKeyword__Is_Void = 253,
  kKeyword__Is_Array = 254,
  kKeyword__Is_Function = 255,
  kKeyword__Is_Reference = 256,
  kKeyword__Is_LvalueReference = 257,
  kKeyword__Is_RvalueReference = 258,
  kKeyword__Is_Fundamental = 259,
  kKeyword__Is_Object = 260,
  kKeyword__Is_Scalar = 261,
  kKeyword__Is_Compound = 262,
  kKeyword__Is_Pointer = 263,
  kKeyword__Is_MemberObjectPointer = 264,
  kKeyword__Is_MemberFunctionPointer = 265,
  kKeyword__Is_MemberPointer = 266,
  kKeyword__Is_Const = 267,
  kKeyword__Is_Volatile = 268,
  kKeyword__Is_Signed = 269,
  kKeyword__Is_Unsigned = 270,
  kKeyword__Is_Same = 271,
  kKeyword__Is_Convertible = 272,
