...
enum class BuiltinTypeKind : unsigned int {
  ...
  kOCLIntelSubgroupAVCImeResultSingleRefStreamout = 44,
  kOCLIntelSubgroupAVCImeResultDualRefStreamout = 45,
  kOCLIntelSubgroupAVCImeSingleRefStreamin = 46,
  kOCLIntelSubgroupAVCImeDualRefStreamin = 47,
  kSveInt8 = 48,
  kSveInt16 = 49,
  kSveInt32 = 50,
  kSveInt64 = 51,
...
enum class StmtStmtClass : unsigned int {
  ...
  kObjCAtCatchStmtClass = 80,
  kObjCAtFinallyStmtClass = 81,
  kObjCAtSynchronizedStmtClass = 82,
  kObjCAtThrowStmtClass = 83,
  kObjCAtTryStmtClass = 84,
  kObjCAutoreleasePoolStmtClass = 85,
  kObjCForCollectionStmtClass = 86,
  kReturnStmtClass = 87,
  kSEHExceptStmtClass = 88,
  kSEHFinallyStmtClass = 89,
  kSEHLeaveStmtClass = 90,
  kSEHTryStmtClass = 91,
  kCaseStmtClass = 92,
  kDefaultStmtClass = 93,
  kSwitchStmtClass = 94,
  kAttributedStmtClass = 95,
  kBinaryConditionalOperatorClass = 96,
  kConditionalOperatorClass = 97,
  kAddrLabelExprClass = 98,
  kArrayInitIndexExprClass = 99,
  kArrayInitLoopExprClass = 100,
  kArraySubscriptExprClass = 101,
  kArrayTypeTraitExprClass = 102,
  kAsTypeExprClass = 103,
  kAtomicExprClass = 104,
  kBinaryOperatorClass = 105,
  kCompoundAssignOperatorClass = 106,
  kBlockExprClass = 107,
  kCXXBindTemporaryExprClass = 108,
  kCXXBoolLiteralExprClass = 109,
  kCXXConstructExprClass = 110,
  kCXXTemporaryObjectExprClass = 111,
  kCXXDefaultArgExprClass = 112,
  kCXXDefaultInitExprClass = 113,
  kCXXDeleteExprClass = 114,
  kCXXDependentScopeMemberExprClass = 115,
  kCXXFoldExprClass = 116,
  kCXXInheritedCtorInitExprClass = 117,
  kCXXNewExprClass = 118,
  kCXXNoexceptExprClass = 119,
  kCXXNullPtrLiteralExprClass = 120,
  kCXXPseudoDestructorExprClass = 121,
  kCXXRewrittenBinaryOperatorClass = 122,
  kCXXScalarValueInitExprClass = 123,
  kCXXStdInitializerListExprClass = 124,
  kCXXThisExprClass = 125,
  kCXXThrowExprClass = 126,
  kCXXTypeidExprClass = 127,
  kCXXUnresolvedConstructExprClass = 128,
  kCXXUuidofExprClass = 129,
  kCallExprClass = 130,
  kCUDAKernelCallExprClass = 131,
  kCXXMemberCallExprClass = 132,
  kCXXOperatorCallExprClass = 133,
  kUserDefinedLiteralClass = 134,
  kBuiltinBitCastExprClass = 135,
  kCStyleCastExprClass = 136,
  kCXXFunctionalCastExprClass = 137,
  kCXXAddrspaceCastExprClass = 138,
  kCXXConstCastExprClass = 139,
  kCXXDynamicCastExprClass = 140,
  kCXXReinterpretCastExprClass = 141,
  kCXXStaticCastExprClass = 142,
  kObjCBridgedCastExprClass = 143,
  kImplicitCastExprClass = 144,
  kCharacterLiteralClass = 145,
  kChooseExprClass = 146,
  kCompoundLiteralExprClass = 147,
  kConceptSpecializationExprClass = 148,
  kConvertVectorExprClass = 149,
  kCoawaitExprClass = 150,
  kCoyieldExprClass = 151,
  kDeclRefExprClass = 152,
  kDependentCoawaitExprClass = 153,
  kDependentScopeDeclRefExprClass = 154,
  kDesignatedInitExprClass = 155,
  kDesignatedInitUpdateExprClass = 156,
  kExpressionTraitExprClass = 157,
  kExtVectorElementExprClass = 158,
  kFixedPointLiteralClass = 159,
  kFloatingLiteralClass = 160,
  kConstantExprClass = 161,
  kExprWithCleanupsClass = 162,
  kFunctionParmPackExprClass = 163,
  kGNUNullExprClass = 164,
  kGenericSelectionExprClass = 165,
  kImaginaryLiteralClass = 166,
  kImplicitValueInitExprClass = 167,
  kInitListExprClass = 168,
  kIntegerLiteralClass = 169,
  kLambdaExprClass = 170,
  kMSPropertyRefExprClass = 171,
  kMSPropertySubscriptExprClass = 172,
  kMaterializeTemporaryExprClass = 173,
  kMatrixSubscriptExprClass = 174,
  kMemberExprClass = 175,
  kNoInitExprClass = 176,
  kOMPArraySectionExprClass = 177,
  kOMPArrayShapingExprClass = 178,
  kOMPIteratorExprClass = 179,
  kObjCArrayLiteralClass = 180,
  kObjCAvailabilityCheckExprClass = 181,
  kObjCBoolLiteralExprClass = 182,
  kObjCBoxedExprClass = 183,
  kObjCDictionaryLiteralClass = 184,
  kObjCEncodeExprClass = 185,
  kObjCIndirectCopyRestoreExprClass = 186,
  kObjCIsaExprClass = 187,
  kObjCIvarRefExprClass = 188,
  kObjCMessageExprClass = 189,
  kObjCPropertyRefExprClass = 190,
  kObjCProtocolExprClass = 191,
  kObjCSelectorExprClass = 192,
  kObjCStringLiteralClass = 193,
  kObjCSubscriptRefExprClass = 194,
  kOffsetOfExprClass = 195,
  kOpaqueValueExprClass = 196,
  kUnresolvedLookupExprClass = 197,
  kUnresolvedMemberExprClass = 198,
  kPackExpansionExprClass = 199,
  kParenExprClass = 200,
  kParenListExprClass = 201,
  kPredefinedExprClass = 202,
  kPseudoObjectExprClass = 203,
  kRecoveryExprClass = 204,
  kRequiresExprClass = 205,
  kSYCLUniqueStableNameExprClass = 206,
  kShuffleVectorExprClass = 207,
  kSizeOfPackExprClass = 208,
  kSourceLocExprClass = 209,
  kStmtExprClass = 210,
  kStringLiteralClass = 211,
  kSubstNonTypeTemplateParmExprClass = 212,
  kSubstNonTypeTemplateParmPackExprClass = 213,
  kTypeTraitExprClass = 214,
  kTypoExprClass = 215,
  kUnaryExprOrTypeTraitExprClass = 216,
